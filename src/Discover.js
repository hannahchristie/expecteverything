          ...
          <div>
            <MDBRow>
              <MDBCol>
                ...
                <p className="lead red-text">find out about the social model of disability, the neurodiversity movement
                  and important ongoing conversations about the nature of ‘normal’</p>
              </MDBCol>
            </MDBRow>
            <MDBRow>
              <MDBCol size="8">
